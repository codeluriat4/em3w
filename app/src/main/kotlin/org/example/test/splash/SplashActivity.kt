 ...
 * actually arrived (or keeps retrying quietly if there's no internet), then hands off
 * straight to the home chart screen.
 */
class SplashActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // No explicit "hover" affordance to teach here, so the orb animates on its own.
        orbView.forceHoverState = true

        // Brand palette: bright near-white teal + brand teal in the outer glow, with a
        // near-black teal anchoring the shadow side.
