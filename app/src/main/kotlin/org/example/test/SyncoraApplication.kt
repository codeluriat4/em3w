 ...
 * retrying quietly if they haven't, e.g. no internet) *before* it hands off to
 * MainActivity. If each activity created its own [TradingChartPipeline], MainActivity's
